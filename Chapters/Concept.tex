...
check*******************'
This is one of two ways of assuming a vehicles future prediction, some planners tend to say that the robot will drive straight in its current direction \todo{find reference} and some planners assume the vehicle to drive along the same lane as they are observed. 
